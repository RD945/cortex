...
export const BASE_URL =
  process.env.CORTEX_TEST_BASE_URL ?? "http://127.0.0.1:3001/api";
export const TEST_API_KEY =
  process.env.CORTEX_TEST_API_KEY ??
  "sk-DEVONLYUSER0001-DEVONLY2222222222222222222222222";
export const TEST_API_KEY_2 =
  process.env.CORTEX_TEST_API_KEY_2 ??
  "sk-DEVONLYUSER0002-DEVONLY3333333333333333333333333";
export const TEST_EMAIL = process.env.CORTEX_TEST_EMAIL ?? "demo@example.com";
export const TEST_PASSWORD = process.env.CORTEX_TEST_PASSWORD ?? "Demo@123";
