import { createLoggerFactory, runWithRequestId } from "@cortex/logger";
import type { Context, Next } from "hono";
import { config } from "../config/index.js";

// Re-export Logger type for convenience
export type { Logger } from "@cortex/logger";

// Service name is always "cortex" for the consolidated container
...
// Create logger using @cortex/logger package factory
