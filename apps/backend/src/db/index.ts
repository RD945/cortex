/**
 * Database initialization for Cortex backend
 *
 * This file uses @cortex/db package for all database functionality.
 *
 ...
 *
 * Queue schema is owned by @cortex/queue package (reusable).
 * Re-exported here with types matching the active database.
 * Service files should import queueJobs from here, not directly from @cortex/queue.
 */
