      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              background:
                "linear-gradient(to bottom right, hsl(0 0% 15%), hsl(0 0% 8%))",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.background =
                "linear-gradient(to bottom right, hsl(0 0% 22%), hsl(0 0% 15%))";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background =
                "linear-gradient(to bottom right, hsl(0 0% 15%), hsl(0 0% 8%))";
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom right, hsl(0 0% 15% / 0.95), hsl(0 0% 8% / 0.95))",
          }}
        >
          {hoveredAction}
        </div>
