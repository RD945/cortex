 ...
 *
 * Manages the ~/.cortex directory structure:
 * ~/.cortex/
...
// Base directory for cortex runtime files
...
export function getCortexDir(): string {
  return path.join(os.homedir(), CORTEX_DIR);
}

/**
 * Get the PIDs directory (~/.cortex/pids)
 */
export function getPidsDir(): string {
  return path.join(getCortexDir(), "pids");
}

/**
 * Get the logs directory (~/.cortex/logs)
 */
export function getLogsDir(): string {
  return path.join(getCortexDir(), "logs");
}

/**
 * Get the models directory (~/.cortex/models)
 */
export function getModelsDir(): string {
  return path.join(getCortexDir(), "models");
}
...
export function ensureDirectories(): void {
  const dirs = [getCortexDir(), getPidsDir(), getLogsDir(), getModelsDir()];
