 ...
 *
 * Re-exports types from @cortex/ai with CLI-specific aliases and additions.
 */

// Re-export engine types from @cortex/ai
// Re-export types from @cortex/ai with CLI-friendly aliases
export type {
  AIContext,
  Dialect,
  EngineConfig,
