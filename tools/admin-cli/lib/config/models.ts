 ...
 *
 * Re-exports config functions from @cortex/ai with CLI-specific wrappers.
 */

import path from "node:path";
import type { AIContext, ModelConfig } from "@cortex/ai";
import {
  // Model CRUD
  addModel,
...
// ============================================================================
// Suitability helpers (Cortex-specific)
// ============================================================================
...
): { id: string; model: import("@cortex/ai").ModelConfig } | undefined {
