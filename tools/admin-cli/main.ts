...
import { type AILogger, setConfigPath, setLoggerFactory } from "@cortex/ai";
...
// CLI Header
console.log(
  boxen(chalk.cyan.bold("Cortex Admin CLI"), {
    padding: 1,
    margin: 1,
    borderStyle: "round",
    borderColor: "cyan",
...
program
  .name("cortex")
  .description(
    "Cortex Admin CLI - Manage providers, models, and configuration",
  )
  .version("1.0.0")
