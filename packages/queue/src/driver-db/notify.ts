/**
 * @cortex/queue/driver-db - PostgreSQL NOTIFY/LISTEN for horizontal scaling
 *
 ...
 * import { createPgNotifyEmitter } from '@cortex/queue/driver-db';
 *
 ...
 * ```typescript
 * import { Client } from 'pg';
 * import { createPgNotifyListener } from '@cortex/queue/driver-db';
 *
