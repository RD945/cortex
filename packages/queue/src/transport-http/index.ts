/**
 * @cortex/queue/transport-http - HTTP transport layer for remote workers
 *
 ...
 * (e.g., using the existing /api/jobs routes in Cortex).
 *
 * @example Remote worker using HTTP transport
 * ```typescript
 * import { createHttpWorker } from '@cortex/queue/transport-http';
 *
 ...
 * ```typescript
 * import { createHttpWorkerFactory } from '@cortex/queue/transport-http';
 *
